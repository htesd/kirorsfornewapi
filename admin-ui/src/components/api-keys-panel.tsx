 ...
 * 反代 API Key 管理面板
 *
 * 客户端调用 /v1/messages 的访问密钥，可配置多个，任意一个均可通过认证。
 * 每个 key 可绑定一个账号分组（分组路由，fail-open）。
 * 增删/启禁/绑定立即生效并持久化到 SQLite。
 */
              ...
              >
                <div className="min-w-0 flex-1">
                  ...
                  <select
                    ...
                    className="mt-1 h-7 w-full max-w-xs rounded border border-input bg-transparent px-2 text-xs focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                    title="该 Key 可用的账号分组（分组路由，fail-open）"
                  >
